				...
				if ( (m = match[1]) ) {
					...
					if ( nodeType === 9 ) {
						if ( (elem = context.getElementById( m )) ) {
							...
							// TODO:0 identify versions id:57
					...
					// Element context
						...
						// Support: IE, Opera, Webkit
						// TODO:0 identify versions id:58
						// getElementById can match elements by name instead of ID
...
function matcherFromGroupMatchers( elementMatchers, setMatchers ) {
	var bySet = setMatchers.length > 0,
		...
		superMatcher = function( seed, context, xml, results, outermost ) {
			...
			// NOTE:0 This can be skipped if there are no unmatched elements (i.e., `matchedCount` id:59
...
var rootjQuery,
	...
	// Strict HTML recognition (#11290:0 must start with <) id:60
...
//	4. _Never_ expose "private" data to user code (TODO:0 Drop _data, _removeData) id:61
...
jQuery.extend( {
	...
	// TODO:0 Now that all calls to _data and _removeData have been replaced id:62
